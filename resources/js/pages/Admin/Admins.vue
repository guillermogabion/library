  ...
  methods: {
    ...
    saveAdmin(){
      if(this.adminForm.id){
        this.$admin.put('/product/update/'+this.adminForm.id,this.adminForm).then(({data}) => {
          this.initialize()
        })
      }
      else{
        this.$admin.post('/product/create',this.adminForm).then(({data}) =>{
    ...
    deleteAdmin(admin){
      this.$admin.delete('/product/delete/'+ admin.id).then(({data}) => {
        this.initialize() 
      })
    }
  },
